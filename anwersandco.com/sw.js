(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["anwersandco\\\\.com(?:/.*)?/ola/services/.*","anwersandco\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://97dc29f7-935e-46bf-8ddb-1be49ed8eaed\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["anwersandco\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/97dc29f7-935e-46bf-8ddb-1be49ed8eaed/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/97dc29f7-935e-46bf-8ddb-1be49ed8eaed/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/"]').map((e => ({
                url: e,
                revision: "1693754008007"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("anwersandco.com-"))).map((e => caches.delete(e))))
            })))
